...
const SkillBadge = ({ image, alt, title, color }: Props) => {
  return (
    <div className="group relative w-24 cursor-default">
      ...
      ></div>
      <div className="relative flex flex-col items-center justify-center gap-4 overflow-hidden rounded-lg border border-zinc-600 bg-zinc-900 px-2 py-4 leading-none duration-150 group-hover:-translate-x-1 group-hover:-translate-y-1 group-hover:border-zinc-100">
        <Image
          width={48}
          height={48}
          alt={alt}
