...
const SkillBadge = ({ image, alt, title, color }: Props) => {
  return (
    <div className="group relative w-24 cursor-default">
      ...
      ></div>
      <div className="relative flex flex-col items-center justify-center gap-4 overflow-hidden rounded-lg border border-zinc-100/60 bg-zinc-900 px-2 py-4 leading-none duration-300 group-hover:-translate-x-2 group-hover:-translate-y-2">
        <Image
          width={48}
          height={48}
          alt={alt}
          className="h-12 w-12 rounded-md object-contain grayscale duration-300 group-hover:grayscale-0"
          src={image}
        />
