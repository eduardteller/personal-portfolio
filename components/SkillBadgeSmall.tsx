...
const SkillBadgeSmall = ({ image, title }: Props) => {
  return (
    <div className="group relative cursor-default">
      ...
      />
      <div className="relative flex items-center gap-1 overflow-hidden rounded-lg border border-zinc-100/80 bg-zinc-900 p-2 leading-none duration-150 group-hover:-translate-x-[2px] group-hover:-translate-y-[2px] group-hover:border-zinc-100">
        <Image
          width={24}
          height={24}
          alt={title}
